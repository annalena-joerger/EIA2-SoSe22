...
namespace L08 {
    ...
    function hndLoad (_event: Event): void {
        ...
        for (let index: number = 0; index < 20; index++) {
            ...
            let xRandomNumber: number = Math.floor(Math.random() * 800);
            let yRandomNumber: number = Math.floor(Math.random() * 600);
    ...
    function drawTriangle (_xRandomNumber: number, _yRandomNumber: number): void {
    ...
    function drawingCircle (_xRandomNumber: number, _yRandomNumber: number): void {
    ...
    function drawingBubble (_xRandomNumber: number, _yRandomNumber: number): void {
    ...
    function drawingLine (_xRandomNumber: number, _yRandomNumber: number): void {
        colorHue = Math.round(Math.random() * 500);
        saturation = Math.round(Math.random() * 140);
        lightness = Math.round(Math.random() * 120);
